...
`configs.track4.souha.paths`, so the same code runs locally and on Kaggle.
"""
...
from configs.track4.souha.paths import DataPaths
from utils.track4.souha.constants import NUM_CLASSES
...
class DiacData:
    def __init__(self, paths: DataPaths):
        self.vocab = json.load(open(paths.vocab, encoding="utf-8"))
