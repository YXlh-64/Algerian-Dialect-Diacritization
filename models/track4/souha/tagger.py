...
`utils.track4.souha.data.build_char_prior`), so the model learns the *residual*
...
from models.track4.souha.crf import CRF
from models.track4.souha.layers import RMSNorm, SinPos
from models.track4.souha.transformer import EncoderLayer, T5RelBias
