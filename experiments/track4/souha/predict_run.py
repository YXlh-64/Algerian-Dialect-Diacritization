...
from configs.track4.souha.training_config import LexicalFallbackConfig
from evaluation.track4.souha.inference import (
    ensemble_predict,
    load_test_set,
    predict_with_confidence,
)
from evaluation.track4.souha.lexical_fallback import apply_fallback
from evaluation.track4.souha.submission import force_space_labels, write_submission
...
if __name__ == "__main__":
    from experiments.track4.souha.train_run import run_training
