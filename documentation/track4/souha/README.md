# Track 4 — Algerian Dialect Diacritization (souha)
...
PYTHONPATH=. python experiments/track4/souha/predict_run.py

# training only
PYTHONPATH=. python -c "from experiments.track4.souha.train_run import run_training; run_training()"

# tests (standalone, no pytest required)
PYTHONPATH=. python tests/track4/souha/test_crf.py
PYTHONPATH=. python tests/track4/souha/test_submission.py
```
