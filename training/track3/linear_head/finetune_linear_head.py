...
# Defaults to --active-model camelbert_mix, the best-scoring run in this group (DER 0.0824). Override with --active-model <key>.
...
_parser.add_argument("--active-model", type=str, default="camelbert_mix",
                      choices=list(MODEL_REGISTRY.keys()),
                      help="Key into MODEL_REGISTRY (default: camelbert_mix, the best-scoring run in this group at DER 0.0824)")
